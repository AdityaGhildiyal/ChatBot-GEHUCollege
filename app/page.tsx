...
export default function ChatbotUI() {
  return (
    <div className="min-h-screen bg-[#1E1E1E] text-white overflow-hidden relative">
      <GridBackground />
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 relative z-10">
        ...
        <div className="text-center mb-12">
          <motion.div
            initial={{ scale: 0.9 }}
            animate={{ scale: 1 }}
            className="inline-block p-2 rounded-lg bg-[#2B2B2B] mb-6"
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
            </svg>
          </motion.div>
          <h1 className="text-6xl font-bold mb-4 bg-gradient-to-r from-[#FADACF] via-[#F4C8B5] to-[#FADACF] bg-clip-text text-transparent">
            Your Personal
          </h1>
          <h1 className="text-6xl font-bold mb-6 bg-gradient-to-r from-[#FADACF] via-[#F4C8B5] to-[#FADACF] bg-clip-text text-transparent">
            GEHU AI Advisor
          </h1>
          <p className="text-gray-400 max-w-lg mx-auto">
            this is a page to get information about Graphic Era Hill University
          </p>
        </div>
